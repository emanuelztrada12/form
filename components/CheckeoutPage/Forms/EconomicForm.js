...
export default function EconomicForm(props) {
  ...
  const calculate = (nvalues) => {
    ...
    setResult(value);
    props.values[props.formField.economic_payment_deuda.name] =
      parseFloat(value);
  };
  ...
  const calc_total = (nvalues) => {
    ...
    let value;
    const newTotal =
      parseFloat(economic_vivienda) +
      parseFloat(economic_food) +
      parseFloat(economic_aporte) +
      parseFloat(economic_water) +
      parseFloat(economic_phone) +
      parseFloat(economic_recreation) +
      parseFloat(economic_vestuario) +
      parseFloat(economic_gastos) +
      parseFloat(economic_trans) +
      parseFloat(economic_medic) +
      parseFloat(economic_estudy) +
      parseFloat(economic_ahorro) +
      parseFloat(economic_other);
    if (lodash.isNaN(newTotal)) value = 0.0;
        ...
        <Grid>
                                    ...
                                    <Grid>
                                      ...
                                      <List dense={dense}>
                                        <ListItem style={{ paddingBottom: "" }}>
                                          ...
                                          />
                                          <SelectField
                                            name={`economic.${index}.${economic_bill.name}`}
                                            label={economic_bill.label}
                                            InputProps={{
                                              startAdornment: (
                                        ...
                                        <ListItem>
                                          ...
                                          <InputField
                                            type="Number"
                                            name={`economic.${index}.${economic_balance.name}`}
                                            label={economic_balance.label}
                                            InputProps={{
                                              startAdornment: (
                                                <InputAdornment position="start">
                                                  Q.
                                        ...
                                        <ListItem>
                                          ...
                                          <InputField
                                            type="Number"
                                            name={`economic.${index}.${economic_monthly_payment.name}`}
                                            label={
                                        ...
                                        <ListItem>
                                          ...
                                          />
                                          <SelectField
                                            name={`economic.${index}.${economic_delinquent_payment.name}`}
                                            label={
                                              economic_delinquent_payment.label
                                            }
                                            data={pagos}
                                            fullWidth
                                          />
          ...
          <Grid>
            <div>
              ...
              >
                Deudas que se encuentran a su nombre, pero otra persona realiza
                los pagos:
              </p>
                                    ...
                                    <Grid>
                                      ...
                                      <List dense={dense}>
                                        <ListItem style={{ paddingBottom: "" }}>
                                          ...
                                          />
                                          <SelectField
                                            name={`economicother.${index}.${economic_billother.name}`}
                                            label={economic_billother.label}
                                            InputProps={{
                                              startAdornment: (
                                                <InputAdornment position="start">
                                                  Q.
                                        ...
                                        <ListItem>
                                          ...
                                          <InputField
                                            type="Number"
                                            name={`economicother.${index}.${amountother.name}`}
                                            label={amountother.label}
                                            InputProps={{
                                              startAdornment: (
                                                <InputAdornment position="start">
                                                  Q.
                                        ...
                                        <ListItem>
                                          ...
                                          <InputField
                                            type="Number"
                                            name={`economicother.${index}.${economic_balanceother.name}`}
                                            label={economic_balanceother.label}
                                            InputProps={{
                                              startAdornment: (
                                                <InputAdornment position="start">
                                                  Q.
                                        ...
                                        <ListItem>
                                          ...
                                          <InputField
                                            type="Number"
                                            name={`economicother.${index}.${economic_monthly_paymentother.name}`}
                                            label={
                                              economic_monthly_paymentother.label
                                            }
                                            InputProps={{
                                              startAdornment: (
                                                <InputAdornment position="start">
                                        ...
                                        <ListItem>
                                          ...
                                          />
                                          <SelectField
                                            name={`economicother.${index}.${economic_delinquent_paymentother.name}`}
                                            label={
                                              economic_delinquent_paymentother.label
                                            }
                                            data={pagos}
                                            fullWidth
                                          />
