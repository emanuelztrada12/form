        ...
        <Grid>
          ...
          <div>
            ...
            >
              ...
              Si su respuesta es sí, indique en observaciones el año que fue
              diagnosticado y si toma algún medicamento.
            </p>
          </div>
          ...
          <Grid container>
            ...
            >
              <label style={{ fontSize: "18px", fontWeight: "bold" }}>
                ¿Ha sufrido incidentes, accidentes o intervenciones quirúrgicas
                que le hayan dejado secuelas físicas?:
              </label>
              <SelectField
              ...
              {accidents === "Si" && (
                <div>
                  <label style={{ fontSize: "18px", fontWeight: "bold" }}>
                    Detalle sus incidentes, accidentes o intervenciones
                    quirúrgicas:
                  </label>
                  <InputField
                                        ...
                                        <Grid>
                                          ...
                                          <List dense={dense}>
                                            ...
                                            >
                                              ...
                                              />
                                              <SelectField
                                                name={`dosis.${index}.${dosis_name.name}`}
                                                label={dosis_name.label}
                                                data={vacunas}
                                                fullWidth
                                              />
                                            </ListItem>
                                            ...
                                            <ListItem>
                                              ...
                                              />
                                              <DatePickerField
                                                name={`dosis.${index}.${dosis_date.name}`}
                                                fullWidth
                                              />
                                            </ListItem>
                                            <Divider />
