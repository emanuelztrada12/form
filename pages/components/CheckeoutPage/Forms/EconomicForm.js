            ...
            <>
                <Grid>
                    ...
                    <Grid>
                        <div>
                            ...
                            >
                                ...
                                tarjetas de crédito, visa cuotas,
                                préstamos o créditos con personas individuales y cualquier
                                deuda que se encuentre en su récord crediticio.
                                                    ...
                                                    <>
                                                        ...
                                                        >
                                                            <Divider style={{ paddingTop: "20px", paddingBottom: "20px" }}>
                                                                <Chip
                                                                    style={{ fontSize: "14px", fontWeight: "bold", paddingTop: "20px", paddingBottom: "20px", paddingLeft: "15px", paddingRight: "15px" }}
                                                            ...
                                                            <h1 style={{
                                                                paddingBottom: "10px", fontSize: "20px", display: "flex",
                                                                justifyContent: "center", fontWeight: "bold"
                                                            }}>Detalle de la deuda : </h1>
                                                            <Grid container spacing={3}>
                                                                <Grid item xs={12} sm={6}>
                                                                    <label style={{ fontSize: "18px", fontWeight: "bold" }}>
                                                                        ¿Fecha de la solicitud?:
                                                                    </label>
                                                                    <DatePickerField name={`economic.${index}.${economic_date.name}`} label={economic_date.label} fullWidth />
                                                                </Grid>
                                                                <Grid item xs={12} sm={6}>
                                                                    <label style={{ fontSize: "18px", fontWeight: "bold" }}>
                                                                        ¿Para que lo utilizó?:
                                                                    </label>
                                                                    <InputField name={`economic.${index}.${economic_use.name}`} label={economic_use.label} fullWidth />
                                                                </Grid>
                                                                <Grid item xs={12} sm={6}>
                                                                    <label style={{ fontSize: "18px", fontWeight: "bold" }}>
                                                                        ¿Debe cancelarlo en un plade de?:
                                                                    </label>
                                                                    <InputField name={`economic.${index}.${economic_plan.name}`} label={economic_plan.label} style={{ paddingBottom: "20px" }} fullWidth />
                                                                </Grid>
                                                            </Grid>
                                                            ...
                                                            <Box sx={{ flexGrow: 1, maxWidth: 752 }}>
                                                                ...
                                                                >
                                                                    <Grid >
                                                                        <Grid >
                                                                            <Typography sx={{ mt: 4, mb: 2 }} variant="h6" component="div" style={{ display: "flex", justifyContent: "center", paddingTop: "20px", fontWeight: "bold" }}>
                                                                                Deuda
                                                                            </Typography>
                                                                            <Divider />
                                                                            <List dense={dense}>
                    ...
                    <div style={{ display: "flex", justifyContent: "center", paddingTop: "10px" }}>
                        ...
                        <Box sx={{ flexGrow: 1, maxWidth: 1800 }} style={{ display: "flex", justifyContent: "center" }} >
                            <Paper elevation={3}
                            >

                                <Typography sx={{ mt: 4, mb: 2 }} variant="h6" component="div" style={{ display: "flex", justifyContent: "center", paddingTop: "5px", fontWeight: "bold" }}>
                                    Ingresos proyectados
                                </Typography>
                                <Grid spacing={3} >
                                    <Grid >
