                ...
                <Grid>
                    ...
                    >
                        <Paper elevation={24} style={{ maxHeight: 1020, overflow: "auto" }}>
                            ...
                            <p style={{ paddingLeft: "15px", paddingTop: "10px", fontSize: "20px", display: "flex", justifyContent: "center" }}>Ingrese la información de sus hijos</p>
                                                    ...
                                                    <>
                                                        <div item xs={12} sm={6} style={{ paddingLeft: "10px", paddingRight: "10px", paddingTop: "10px" }}>
                                                            ...
                                                            <SelectField
                                                                ...
                                                                data={life}
                                                                onChange={(e) => {
                                                                    gettingValue(`son.${index}.${family_son_life.name}`, e)
                                                                }
                                                                }
                                                                fullWidth
                                                            />

                                                            {(valuess === `Si.son.0.family_son_life`) && (
                                                                <div>
                                                                    <h1>{valuess}</h1>
